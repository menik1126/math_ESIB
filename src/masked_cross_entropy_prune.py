...
def masked_cross_entropy(logits, target, length, logits_noGrad = None, target_noGrad = None, length_noGrad = None, temperature = None, problem_output= None, problem_output_noGrad=None):
    ...
    def compute_vae_loss(all_node_outputs_old, logits_noGrad = None, features2_mask = None):
    ...
    if config.is_RDrop and config.is_train_kl:
       ...
       if config.is_mid_loss:
            vae_loss = compute_vae_loss(problem_output, logits_noGrad = problem_output_noGrad)
            loss   += config.contra_weight * vae_loss
...
def masked_cross_entropy_unsym(logits, target, length, logits_noGrad = None, target_noGrad = None, length_noGrad = None, temperature = None, problem_output= None, problem_output_noGrad=None, mean=None, logvar=None):
    ...
    def compute_kl_loss(all_node_outputs_old, pad_mask, logits_noGrad = None, features2_mask = None):
        ...
        if pad_mask is not None:
            ...
            if config.is_loss_no_mask ==True:
